...
const HomeIsland = () => {
    const divData = [
        ...
        {icon: <VscNotebook size={'2em'} style={{color: '#BB86FC'}}/>, text: 'Go to your journal', route: "questions"},
        {icon: <HiMagnifyingGlass size={'2em'} style={{color: '#BB86FC'}}/>, text: 'See your data', route: "questions"},
    ];
